...
{
   echo "Usage:"
   echo -e "\t$0 -h -t retry taskid patch_url target_disk patch_original_size patch_md5"
...
# this function is to check whether the target disk size less than source patch size
...
main()
{
        ...
        export WGETOPT="--tries=3 --wait=120 --connect-timeout=30 --timeout=12 -q" 
